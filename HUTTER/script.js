...
// Para manipulação do botão voltar para o menu

document.addEventListener('DOMContentLoaded', function() {
    const cancelButton = document.querySelector('.cancel');

    cancelButton.addEventListener('click', function() {
        // Aqui eu posso redirecionar o usuário para a página do menu ou executar outra ação desejada
        window.location.href = 'index.html'; // Substitua 'url_do_seu_menu.html' pela URL do seu menu
    })
})
